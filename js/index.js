...
let app = Vue.createApp({
	data() {
		return {
			list: [
				new Subject(2020, "ROMA VA5", "羅馬 VA5", "ROMA V&A5 H 2020.png", "ROMA V&A5 H 2020_sketch.png"),
				new Subject(2020, "ROMA VA5", "羅馬 VA5", "ROMA V&A5 B 2020.png", "ROMA V&A5 B 2020_sketch.png"),
				new Subject(2018, "BAOREN V&A3", "成大寶仁V&A3", "BAOREN V&A3 2018.jpg", "BAOREN V&A3 2018_sketch.png"),
